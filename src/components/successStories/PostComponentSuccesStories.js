...
class PostComponentSuccesStories extends React.Component {
    ...
    componentDidMount() {
        PostService.getSuccessStories().then((response) => {
                        ...
                        <div
                            ...
                            <div className="d-flex flex-row align-items-center">
                                <h2 className={headerClass}>
                                    ...
                                    Animale ajunse acasă - istorii de succes
                                </h2>
                                {currentPage && (
...
export default PostComponentSuccesStories